...
const CompanySettings = () => {
  ...
  const [vatIdentifier, setVatIdentifier] = React.useState(
    companyMe.vatIdentifier,
  )
    ...
    <div>
      <form onSubmit={SaveCompany}>
        ...
        <InputForm
          ...
          name="activity"
          value={activity}
          onChange={(x) => setActivity(x.target.value)}
        ...
        <InputForm
          ...
          name="legalStatus"
          value={legalStatus}
          onChange={(x) => setLegalStatus(x.target.value)}
          disabled={disableUpdate}
        />
        <InputForm
          label="Capital"
          ...
          name="capital"
          value={capital}
          onChange={(x) => setCapital(x.target.value)}
          disabled={disableUpdate}
        />
        ...
        <InputForm
          ...
          name="zip"
          value={zip}
          onChange={(x) => setZip(x.target.value)}
          disabled={disableUpdate}
        />
        <InputForm
          label="Ville"
        ...
        <InputForm
          ...
          name="website"
          value={website}
          onChange={(x) => setWebsite(x.target.value)}
          disabled={disableUpdate}
        />
        ...
        <InputForm
          ...
          name="siret"
          value={siret}
          onChange={(x) => setSiret(x.target.value)}
          disabled={disableUpdate}
        />
        <InputForm
          ...
          name="vatIdentifier"
          value={vatIdentifier}
          onChange={(x) => setVatIdentifier(x.target.value)}
          disabled={disableUpdate}
        />
        <InputForm
          label="Code NAF"
          ...
          name="nafCode"
          value={nafCode}
          onChange={(x) => setNafCode(x.target.value)}
          disabled={disableUpdate}
        />
